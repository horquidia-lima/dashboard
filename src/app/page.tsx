          ...
          <div className="grid grid-cols-form gap-3 py-5">
           ...
           <div className="grid grid-cols-form gap-3 py-5">
            ...
            <Select placeholder="Select a timezone">
              <SelectItem value="ut8" text="Pacific Standard Time (PST) UTC−08:00"/>
              <SelectItem value="ut3" text="Pacific Standard Time (PST) UTC−08:00"/>
            </Select>
          </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex items-center gap-1">
                  <button type="button" className="rounded-md p-2 hover:bg-zinc-50">
                    <Bold className="h-4 w-4 text-zinc-500" startOffset={3}/>
                  </button>
                  <button type="button" className="rounded-md p-2 hover:bg-zinc-50">
                    <Italic className="h-4 w-4 text-zinc-500" startOffset={3}/>
                  </button>
                  <button type="button" className="rounded-md p-2 hover:bg-zinc-50">
                    <Link className="h-4 w-4 text-zinc-500" startOffset={3}/>
                  </button>
                  <button type="button" className="rounded-md p-2 hover:bg-zinc-50">
                    <List className="h-4 w-4 text-zinc-500" startOffset={3}/>
                  </button>
                  <button type="button" className="rounded-md p-2 hover:bg-zinc-50">
                    <ListOrdered className="h-4 w-4 text-zinc-500" startOffset={3}/>
                  </button>
                </div>
              </div>
