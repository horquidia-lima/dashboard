...
export function FileItem({name, size}: FileItemProps) {
    ...
    return(
        <div className="group flex items-start gap-4 rounded-lg border border-zinc-200 p-4">
            <div className="rounded-full border-4 border-violet-100 bg-violet-100 p-2 text-violet-600">
            ...
            <div className="flex flex-1 flex-col items-start gap-1">
               ...
               <button type="button" className="text-sm font-semibold text-error-700 hover:text-error-900">
                Try again
               </button>
            </div>
            ) : (
